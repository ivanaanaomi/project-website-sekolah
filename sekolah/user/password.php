...
if ($msg == 'err2') {
    ...
    fade show" role="alert">
    <i class="fa-solid fa-triangle-exclamation"></i> 
    Ganti password gagal, password yang anda masukkan salah.
    <button type="button" class="btn-close" data-bs-dismiss="alert" 
    aria-label="Close"></button>
    </div>';
}
        ...
        <div class="container-fluid px-4">
            ...
            <form action="proses-password.php" method="POST">
                ...
                <div class="card">
                    ...
                    fa-pen-to-square me-1"></i> Ganti Password</span>
                    ...
                    <div class="card-body">
                        <div class="mb-3 row">
                            <div class="col-7">
                                <label for="curPass" class="form-label">
                                    Password Lama</label>
                        ...
                        <div class="mb-3 row">
                            <div class="col-7">
                                ...
                                <input type="password" class="form-control"
                                    ...
                                    placeholder="Konfirmasi ulang password baru anda"
                                    required>
                            </div>
                        </div>
                    </div>
