<body class="sb-nav-fixed">
    <nav class="sb-topnav navbar navbar-expand bg-light">
        <!-- Sidebar Toggle-->
        <button class="btn btn-link btn-sm order-1 order-lg-0 me-1 me-lg-0" id="sidebarToggle" href="#!"><i class="fas fa-bars"></i></button>
        <!-- Navbar Brand-->
        <a class="navbar-brand ms-2 ms-md-0" href="<?= $main_url ?>index.php">SMPN 14 Pematangsiantar</a>
        <!-- Navbar Search-->
        <form class="d-none d-md-inline-block form-inline ms-auto me-0 me-md-3 my-2 my-md-0">
            <span class="text-capitalize"><?= $_SESSION["ssUser"] ?></span>
        </form>
        <!-- Navbar-->
                        ...
                        <div class="row g-0">
                            <div class="col-md-4">
                                <img src="<?= $main_url ?>asset/image/<?= $profile['foto'] ?>"
                                    ...
                                    height: 140px; object-fit: cover;" alt="Gambar User">
                            </div>
                            <div class="col-md-8">
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-9">
                                            ...
                                            border-0 bg-transparent text-capitalize" id="nama"
                                                value=": <?= $profile['nama'] ?>">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <label for="jabatan" class="col-sm-3 
                                        col-form-label pe-0">Jabatan</label>
                                        <div class="col-sm-9">
                                            <input type="text" readonly class="form-control 
                                            border-0 bg-transparent text-capitalize" id="jabatan"
                                                value=": <?= $profile['jabatan'] ?>">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <label for="alamat" class="col-sm-3 
                                        col-form-label pe-0">Alamat</label>
                                        <div class="col-sm-9">
                                            <textarea id="alamat" cols="30" rows="2"
                                                class="form-control border-0 bg-transparent text-capitalize"
