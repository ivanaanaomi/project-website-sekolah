...
$title = "Tambah Ekskul - SMPN 14 Pematangsiantar";
                        ...
                        <div class="row">
                            <div class="col-8">
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-9" style="margin-left: -50px;">
                                        <input type="text" class="form-control border-0 border-bottom ps-2"
                                            id="nama_ekskul" name="nama_ekskul" placeholder="Nama Ekstrakurikuler" required>
                                    </div>
                                </div>
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-9" style="margin-left: -50px;">
                                        <textarea name="keterangan" id="keterangan" cols="30" rows="5"
                                            class="form-control" placeholder="Tulis Keterangan..." required></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-9" style="margin-left: -50px;">
                                        <input type="text" class="form-control border-0 border-bottom ps-2"
                                            id="pembina_putra" name="pembina_putra" placeholder="Opsional">
                                    </div>
                                </div>
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-9" style="margin-left: -50px;">
                                        <input type="text" class="form-control border-0 border-bottom ps-2"
                                            id="pembina_putri" name="pembina_putri" placeholder="Opsional">
                                    </div>
                                </div>
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-9" style="margin-left: -50px;">
                                        <input type="text" class="form-control border-0 border-bottom ps-2"
                                            id="pelatih" name="pelatih" placeholder="Opsional">
                                    </div>
                                </div>
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-9" style="margin-left: -50px;">
                                        <input type="text" class="form-control border-0 border-bottom ps-2"
                                            id="hari" name="hari" placeholder="Masukkan jadwal kegiatan" required>
                                    </div>
                                </div>
                            </div>
