                        ...
                        <div class="row">
                            <div class="col-8">
                                ...
                                <div class=" mb-3 row">
                                    ...
                                    <div class="col-sm-9" style="margin-left: -50px;">
                                        <input type="text" class="form-control border-0
                                    border-bottom ps-2" id="jabatan" name="jabatan" value="<?= $data['jabatan'] ?>">
                                    </div>
                                </div>
                                <div class="mb-3 row">
                                ...
                                <div class="mb-3 row">
                                    ...
                                    border-bottom ps-2" id="kontak" name="kontak" value="<?= $data['kontak'] ?>"
                                ...
                                col-form-label">Alamat</label>
                                    ...
                                    <div class="col-sm-9" style="margin-left: -50px;">
                                        <textarea name="alamat" id="alamat" cols="30"
                                            ...
                                            placeholder="Alamat Guru"><?= $data['alamat'] ?></textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="col-4 text-center px-5">
                                <input type="hidden" name="fotoLama" value="<?= $data['foto'] ?>">
                                <img src="../asset/image/<?= $data['foto'] ?>" alt="Foto Guru"
